// src/plugins/hotel/functions/generate-booking-confirmation-pdf/__tests__/pdf-generation.test.ts
import { generateBookingConfirmationPDF } from '../generate-booking-confirmation-pdf';
