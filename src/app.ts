...
const processWithOpenAI = async (userMsg, userJid, chatId = null, userName = null) => {
    ...
    try {
        ...
        // 🔧 SIMPLIFICADO: Verificar y cancelar runs activos (sin reintentos agresivos)
        try {
            ...
            if (activeRun) {
                ...
                try {
                    ...
                    logSuccess('ACTIVE_RUN_CANCELLED', `Run cancelado exitosamente`, {
                        shortUserId,
                        runId: activeRun.id,
                        threadId
                    });
                    ...
                    logError('RUN_CANCEL_ERROR', `Error cancelando run`, { 
                        shortUserId,
                        runId: activeRun.id,
...
app.post('/hook', async (req, res) => {
    try {
        ...
        // Prevenir procesamiento de mensajes duplicados
